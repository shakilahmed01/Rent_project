					...
					@if ($message = Session::get('success'))
                        ...
                        <form method="POST" action="{{ route('flat_update') }}" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
              							...
              							<div class="col-sm-12 col-md-10">
              								<input class="form-control" name="s_charge" value="{{$list->s_charge}}" placeholder="Service Charge" type="numeric">
              							</div>
              						</div>
                          <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Flat Size</label>
                            <div class="col-sm-12 col-md-10">
                              <input type="text" class="form-control" placeholder="Flat Size" name="flat_size" value="{{$list->flat_size}}">
                            </div>
                          </div>
                          <div class="form-group row">
                              ...
                              <div class="col-md-6 col-sm-12">
                                ...
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group form-float">
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo1 }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group form-float">
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo2 }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group form-float">
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo3 }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group form-float">
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo4 }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group form-float">
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo5 }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group form-float">
                                <div class="card">
                                   ...
                                   <div class="body">
                                       ...
                                       <img src="{{ asset('public/uploads/flats') }}/{{ $list->photo6 }}" alt="">
                                   </div>
                               </div>
                          </div>
													<div class="form-group row">
