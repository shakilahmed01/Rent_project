													...
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo1 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo2 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo3 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo4 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo5 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/ponds') }}/{{ $list->photo6 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group row">
