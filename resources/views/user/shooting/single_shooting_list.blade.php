			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					@if ($message = Session::get('success'))
												...
												@endif
                        <form method="POST" action="{{ route('shooting_update') }}" enctype="multipart/form-data">
              						@csrf
                            ...
                            <div class="col-sm-12 col-md-10">
                              <input class="form-control" value="{{$list->phone}}" name="phone" placeholder="" type="text" >
              						...
              						<div class="form-group row">
              							...
              							<div class="col-sm-12 col-md-10">
              								<input class="form-control" value="{{$list->shooting_name}}" name="shooting_name" placeholder="Location" type="text">
              							</div>
              						</div>
                          <div class="form-group row">
                          ...
                          <div class="form-group">
                            <div class="row">
                              ...
                              <div class="col-md-6 col-sm-12">
                                ...
                                <div class="custom-control custom-checkbox mb-5">
                                  <input type="text" name="vegetations" value="{{$list->vegetations}}" class="form-control" id="customCheck8">
                                  <label class="custom-control-label" for="customCheck8">Vegetations</label>
                                </div>
													...
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo1 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo2 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo3 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo4 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo5 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/shootings') }}/{{ $list->photo6 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group row">
