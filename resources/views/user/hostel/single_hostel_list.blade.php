													...
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo1 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo2 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo3 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo4 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo5 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hostels') }}/{{ $list->photo6 }}" alt="">
																	 </div>
															 </div>
													</div>
													<div class="form-group row">
