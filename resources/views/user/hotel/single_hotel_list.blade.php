					...
					@if ($message = Session::get('success'))
                        ...
                        <form method="POST" action="{{ route('hotel_update') }}" enctype="multipart/form-data">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                              <input type="text" class="form-control" placeholder="Guest Count" name="description" value="{{$list->description}}">
                            </div>
                          </div>
													...
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo1 }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo2 }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo3 }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo4 }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo5 }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group form-float">
																<div class="card">
																	 ...
																	 <div class="body">
																			 ...
																			 <img src="{{ asset('public/uploads/hotels') }}/{{ $list->photo6 }}" alt="" width="100px">
																	 </div>
															 </div>
													</div>
													<div class="form-group row">
