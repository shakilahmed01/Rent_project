						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Update Play ground</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							...
							<p class="mb-30">Updating Play ground Details</p>
						</div>
					...
					@if ($message = Session::get('success'))
												...
												@endif
					<form method="POST" action="{{ route('playground_update') }}" enctype="multipart/form-data">
						@csrf
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <div class="custom-control custom-checkbox mb-5">
                    ...
                    <label class="custom-control-label" for="customCheck8">Laundry </label>
									...
									<div class="custom-control custom-checkbox mb-5">
                    <input type="text" name="change_room" value="{{$list->change_room}}" class="form-control" id="customCheck9">
