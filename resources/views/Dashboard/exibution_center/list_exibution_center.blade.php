		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
              ...
              <tr>
                ...
                <td>
                  <a href="{{ url('/exibutioncenter/edit/') }}/{{ $list->id }}" class=" btn-sm btn-primary">Edit</a>
                  <hr>
                  <a href="{{ url('/exibutioncenter/delete') }}/{{ $list->id }}" onclick="confirmAction()" class=" btn-sm btn-danger">Delete</a>
                </td>
              </tr>
          @endforeach
				...
				<div class="pd-20 card-box mb-30">
					...
					<table id="tblStocks"  class="table">
						<thead>
							<tr>
                <th scope="col">Id</th>
                <th scope="col">Exibution Center Name</th>
                <th scope="col">Address</th>
                <th scope="col">Asking Rent/Cost + Service Charge</th>
                <th scope="col">Room Size</th>
                <th scope="col">Room Type</th>
                ...
                <td>{{$trashed_list->exibution_center_name}}</td>
                ...
                <td>{{$trashed_list->lift}}</td>
								...
								<td>
								<img src="{{ asset('uploads/exibution_centers') }}/{{ $trashed_list->photo }}" alt="">
								</td>
								<td>

									<a href="{{ url('exibutioncenter/restore') }}/{{ $trashed_list->id }}" class=" btn-sm btn-success">Restore</a>
								</td>
							</tr>
					@endforeach
