		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Community Center Details</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">List Community Center</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					...
					<table id="tblStocks" class="table">
						<thead>
							<tr>
                <th scope="col">Id</th>
                <th scope="col">Community Center Name</th>
              ...
              <tr>
                ...
                <td>
                  <a href="{{ url('/community/edit/') }}/{{ $list->id }}" class=" btn-sm btn-primary">Edit</a>
                  <hr>
                  <a href="{{ url('community/delete') }}/{{ $list->id }}" onclick="confirmAction()" class=" btn-sm btn-danger">Delete</a>
          ...
          @endforeach
                ...
                <td>{{$trashed_list->community_name}}</td>
                ...
                <td>{{$trashed_list->lift}}</td>
								...
								<td>
								<img src="{{ asset('uploads/communities') }}/{{ $trashed_list->photo }}" alt="">
								</td>
								<td>

									<a href="{{ url('community/restore') }}/{{ $trashed_list->id }}" class=" btn-sm btn-success">Restore</a>
								</td>
							</tr>
					@endforeach
