        ...
        <div class="container">
            ...
            <div class="row row1">
                <div class="col-md-7 mx-4">
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('picnic_spot')}}'">
                                  <span class="icon-bilboard service_item"></span>
                                      <br>
                                  <span class="service_item_name"> Picnic</span>
                          </div>
                    </div>
                 ...
                 <div class="items">
                    ...
                    @foreach($picnics as $picnic)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/picnics') }}/{{ $picnic->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$picnic->price}}</h5>
                         <p class="card-text">{{$picnic->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <span>{{$picnic->type}}</span>
                         </p>

                           <a href="{{ url('/picnic/details/') }}/{{ $picnic->id }}"class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
