                 ...
                 <div class="items">
                    ...
                    @foreach($ponds as $pond)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/ponds') }}/{{ $pond->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$pond->price}}</h5>
                         <p class="card-text">{{$pond->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <a href="{{ url('/pond/details/') }}/{{ $pond->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
