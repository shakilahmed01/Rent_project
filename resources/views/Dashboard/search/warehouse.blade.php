        ...
        <div class="container">
            ...
            <div class="row row1">
                <div class="col-md-7 mx-4">
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('warehouse')}}'">
                 ...
                 <div class="items">
                    ...
                    @foreach($warehouses as $warehouse)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/warehouses') }}/{{ $warehouse->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$warehouse->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Land Area {{$warehouse->land_area}}</span>
                         </p>

                           <a href="{{ url('/warehouse/details/') }}/{{ $warehouse->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
