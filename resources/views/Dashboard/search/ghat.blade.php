        ...
        <div class="container">
            ...
            <div class="row row1">
                <div class="col-md-7 mx-4">
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('ghat')}}'">
                 ...
                 <div class="items">
                    ...
                    @foreach($ghats as $ghat)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/ghats') }}/{{ $ghat->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$ghat->price}}</h5>
                         <p class="card-text">{{$ghat->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <a href="{{ url('/ghat/details/') }}/{{ $ghat->id }}"class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
