                    ...
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('room')}}'">
                                  <span class="icon-room service_item"></span>
                                      <br>
                                  <span class="service_item_name"> Community Center</span>
                          </div>
                    </div>
                            ...
                            <div class="row   justify-content-between">
                                  ...
                                  <div class="my-4 ">
                                      ...
                                      <div class="form-check form-check-inline mx-3 pt-2">
                                          ...
                                          <div class="form-check form-check-inline mx-3 pt-2">
                                              <input class="form-check-input" type="checkbox" name="filter[fire_safety]" id="fire" value="fire">
                 ...
                 <div class="items">
                    ...
                    @foreach($communities as $community)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/communities') }}/{{ $community->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$community->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span>Floor Level {{$community->floor_level}}</span>
                         </p>

                           <a href="{{ url('/community/details/') }}/{{ $community->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
