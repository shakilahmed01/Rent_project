                 ...
                 <div class="items">
                    ...
                    @foreach($rooms as $room)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/rooms') }}/{{ $room->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$room->price}}</h5>
                         ...
                         <a href="{{ url('/room/details/') }}/{{ $room->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
