                 ...
                 <div class="items">
                    ...
                    @foreach($rooftops as $rooftop)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/rooftops') }}/{{ $rooftop->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$rooftop->price}}</h5>
                         <p class="card-text">{{$rooftop->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Land Area {{$rooftop->land_area}}</span>
                         </p>

                           <a href="{{ url('/rooftop/details/') }}/{{ $rooftop->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
