                            ...
                            <div class="row   justify-content-between">
                                ...
                                <div class="my-4 ">
                                    <div class="form-check form-check-inline mx-3 pt-2">
                                        ...
                                        <div class="form-check form-check-inline mx-3 pt-2">
                                            <input class="form-check-input" type="checkbox" name="filter[drainage_system]" id="drainage_system" value="drainage_system">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="sliderText"> Area Range  </div>
                                                <div class="d-flex  ">
                                                    <input type="number" name="filter[land_area]" min=100 max="9900000" oninput="validity.valid||(value='100');" id="min_price"
                                                        class="price-range-field form-control me-2" placeholder="Min-size" />
                                                    <input type="number" name="filter[land_area]" min=100 max="10000000" oninput="validity.valid||(value='1000000');" id="max_price"
                 ...
                 <div class="items">
                    ...
                    @foreach($lands as $land)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/lands') }}/{{ $land->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$land->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Land Area {{$land->land_area}}</span>
                         </p>

                           <a href="{{ url('/land/details/') }}/{{ $land->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
