                    ...
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('room')}}'">
                                  <span class="icon-room service_item"></span>
                                      <br>
                                  <span class="service_item_name">Restaurant</span>
                          </div>
                    </div>
                 ...
                 <div class="items">
                    ...
                    @foreach($restaurants as $restaurant)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/restaurants') }}/{{ $restaurant->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$restaurant->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Room Size {{$restaurant->room_size}}sqrft</span>
                         </p>

                           <a href="{{ url('/restaurant/details/') }}/{{ $restaurant->id }}" class="btn btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
