                            ...
                            <div class="row   justify-content-between">
                                ...
                                <div class="my-4 ">
                                    ...
                                    <div class="form-check form-check-inline mx-3 pt-2">
                                        ...
                                        <div class="form-check form-check-inline mx-3 pt-2">
                                            <input class="form-check-input" type="checkbox" name="filter[fire_exit]" id="fire" value="fire">
                 ...
                 <div class="items">
                    ...
                    @foreach($offices as $office)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/offices') }}/{{ $office->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$office->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span>Floor Level {{$office->floor_level}}</span>
                         </p>

                           <a href="{{ url('/office/details/') }}/{{ $office->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
