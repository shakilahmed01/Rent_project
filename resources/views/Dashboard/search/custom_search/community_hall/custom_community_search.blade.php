        ...
        <div class="container-fluid">
            ...
            <div class="row row1">
                <div class="col-md-7 mx-4">
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('community_hall')}}'">
                 ...
                 <div class="items">
                   ...
                   @foreach($array as $arrays)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/communities') }}/{{ $arrays->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
