        ...
        <div class="containerX">
            <div class="product-divX">
                <div class="product-div-left">
                    <div class="picZoomer">
                        <img src="{{ asset('uploads/warehouses') }}/{{ $array->photo }}" alt="">
                    </div>
                    ...
                    <div class="carousel-inner">
                      ...
                      <li><img class="imgX" src="{{ asset('uploads/warehouses') }}/{{ $array->photo }}" alt=""></li>
                        <li><img class="imgX" src="{{ asset('uploads/warehouses') }}/{{ $array->photo }}" alt=""></li>
                        <li><img class="imgX" src="{{ asset('uploads/warehouses') }}/{{ $array->photo }}" alt=""></li>
                      ...
                      <div class="carousel-item">
                        ...
                        <li><img  src="{{ asset('uploads/warehouses') }}/{{ $array->photo }}" alt=""></li>
