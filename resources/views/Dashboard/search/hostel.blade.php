                            ...
                            <div class="row  justify-content-between ">
                              ...
                              <div class="my-4 ">
                                  ...
                                  <div class="form-check form-check-inline mx-3 pt-2">
                                      ...
                                      <div class="form-check form-check-inline mx-3 pt-2">
                                          <input class="form-check-input" type="checkbox" name="filter[fire_exit]" id="parking" value="fire">
                 ...
                 <div class="items">
                    ...
                    @foreach($hostels as $hostel)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/hostels') }}/{{ $hostel->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$hostel->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span class="btn btn-success">Room Type {{$hostel->room_type}}</span>
                         </p>

                           <a href="{{ url('/hostel/details/') }}/{{ $hostel->id }}" class="btn btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
