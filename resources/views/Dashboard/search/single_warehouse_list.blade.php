...
<!-- <img class="bzoom_thumb_image" src=" {{ asset('Frontend/assets/img/single_pg/house_1.jpg') }}" title="first img" /> -->
    ...
    <section id="default" class="padding-top0">
      ...
      <div class="xzoom-container">
            <img class="xzoom zoom_main" id="xzoom-default" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo }}" xoriginal=" {{ asset('public/uploads/warehouses') }}/{{ $list->photo }}" />
            <div class="xzoom-thumbs" style="display:flex; margin-top:10px;">
              <a href=" {{ asset('public/uploads/warehouses') }}/{{ $list->photo1 }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo1 }}"  xpreview=" {{ asset('public/uploads/warehouses') }}/{{ $list->photo1 }}"  >
              </a>
              <a href="{{ asset('public/uploads/warehouses') }}/{{ $list->photo2 }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo2 }}"  >
              </a>
              <a href="{{ asset('public/uploads/warehouses') }}/{{ $list->photo3 }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo3 }}"  >
              </a>
              <a href="{{ asset('public/uploads/warehouses') }}/{{ $list->photo4 }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo4 }}"  >
              </a>
              <a href="{{ asset('public/uploads/warehouses') }}/{{ $list->photo5 }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo5 }}"  >
              </a>
              <a href="{{ asset('public/uploads/warehouses') }}/{{ $list->photo6 }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo6 }}"  >
              </a>
              <a href="{{ asset('public/uploads/warehouses') }}/{{ $list->photo }}">
                <img class="xzoom-gallery thumb" width="50" src="{{ asset('public/uploads/warehouses') }}/{{ $list->photo }}"  >
              </a>
    ...
    <!-- default end -->
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 product-div-right">
                <div>
                    <h2>Posted By-</h2>
                    <div class="d-flex">
                    <img  src="{{asset('public/uploads/registers')}}/{{$list->Warehouse_relationBetweenUser->photo}}" class="rounded-circle single-pg-img"  alt="" srcset="">
                    ...
                    <h2 class="fw-bold">{{$list->Warehouse_relationBetweenUser->name}}</h2>
                ...
                <div class="btn-groups d-flex flex-lg-row flex-md-row flex-sm-column flex-column">
                    ...
                    <button type="button" onclick="location.href='mailto:{{$list->Warehouse_relationBetweenUser->email}}'" class="btn btn-dark rounded-pill text-white  me-2 mt-sm-2 mt-2">
