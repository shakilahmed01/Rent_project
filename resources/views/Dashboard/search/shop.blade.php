                 ...
                 <div class="items">
                    ...
                    @foreach($shops as $shop)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/shops') }}/{{ $shop->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$shop->price}}</h5>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Land Area {{$shop->land_area}}</span>
                         </p>

                           <a href="{{ url('/shop/details/') }}/{{ $shop->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
