                 ...
                 <div class="items">
                    ...
                    @foreach($hotels as $hotel)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/hotels') }}/{{ $hotel->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$hotel->price}}</h5>
                         <p class="card-text">{{$hotel->hotel_name}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                          ...
                          <a href="{{ url('/hotel/details/') }}/{{ $hotel->id }}"class="btn btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
