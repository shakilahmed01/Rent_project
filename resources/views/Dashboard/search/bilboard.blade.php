                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="sliderText">  Price Range  </div>
                                                <div class="d-flex  ">
                                                    <input type="number" name="[price]" min=100 max="9900000" oninput="validity.valid||(value='100');" id="min_price"
                                                        class="price-range-field form-control me-2" placeholder="Min-price" />

                                                    <input type="number" name="[price]" min=100 max="10000000" oninput="validity.valid||(value='1000000');" id="max_price"
                 ...
                 <div class="items">
                    ...
                    @foreach($bilboards as $bilboard)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/bilboards') }}/{{ $bilboard->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$bilboard->price}}</h5>
                         <p class="card-text">{{$bilboard->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <span>{{$bilboard->type}}</span>
                         </p>

                           <a href="{{ url('/bilboard/details/') }}/{{ $bilboard->id }}"class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
