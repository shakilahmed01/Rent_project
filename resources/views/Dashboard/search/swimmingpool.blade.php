...
<head>
    ...
    <title>ToletX-Swimmingpools</title>
  </head>
  <body>
                    ...
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('room')}}'">
                                  <span class="icon-room service_item"></span>
                                      <br>
                                  <span class="service_item_name">Swimming pools</span>
                          </div>
                    </div>
                 ...
                 <div class="items">
                    ...
                    @foreach($swimmingpools as $swimmingpool)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/swimmingpools') }}/{{ $swimmingpool->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$swimmingpool->price}}</h5>
                         <p class="card-text">{{$swimmingpool->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Land Area {{$swimmingpool->land_area}}</span>
                         </p>

                           <a href="{{ url('/swimmingpool/details/') }}/{{ $swimmingpool->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
