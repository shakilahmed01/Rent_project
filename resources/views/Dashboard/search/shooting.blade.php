        ...
        <div class="container">
            ...
            <div class="row row1">
                <div class="col-md-7 mx-4">
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('shooting_spot')}}'">
                          ...
                          <form class="form-horizontal top-form" action="{{route('shootingspot_search')}}" method="get" role="form">
                            <div class="row   justify-content-between">
                                ...
                                <div class="my-4 ">
                                    ...
                                    <div class="form-check form-check-inline mx-3 pt-2">
                                        <input class="form-check-input" type="checkbox" name="filter[dining]" id="wifi" value="dining">
                 ...
                 <div class="items">
                    ...
                    @foreach($shootings as $shooting)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('public/uploads/shootings') }}/{{ $shooting->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body">
                         <h5 class="card-title">Price BDT:{{$shooting->price}}</h5>
                         <p class="card-text">{{$shooting->address}}</p>
                         <span>
                         ...
                         <p class="mt-3">
                           ...
                           <span >Land Area {{$shooting->land_area}}</span>
                         </p>

                           <a href="{{ url('/shooting/details/') }}/{{ $shooting->id }}" class="btn btn-custom-color2 check-detail mt-2  ">Check Details</a>
