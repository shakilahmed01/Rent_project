		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
              ...
              <tr>
                ...
                <td>
                  <a href="{{ url('/parking/edit/') }}/{{ $list->id }}" class=" btn-sm btn-primary">Edit</a>
                  <hr>
                  <a href="{{ url('parking/delete') }}/{{ $list->id }}"  onclick="confirmAction()" class=" btn-sm btn-danger">Delete</a>
          ...
          @endforeach
                ...
                <td>{{$trashed_list->floor_height}}</td>
                <td>{{$trashed_list->vehicle_type}}</td>
								<td>
								<img src="{{ asset('uploads/parkings') }}/{{ $trashed_list->photo }}" alt="">
								</td>
								<td>

									<a href="{{ url('parking/restore') }}/{{ $trashed_list->id }}" class=" btn-sm btn-success">Restore</a>
								</td>
							</tr>
					@endforeach
