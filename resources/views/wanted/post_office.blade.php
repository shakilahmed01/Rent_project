                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <div class="custom-control custom-checkbox mb-5">
                    ...
                    <label class="custom-control-label" for="customCheck5">Emergency Lift</label>
									...
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="electricity" value="electricity" class="custom-control-input" id="customCheck6">
                    <label class="custom-control-label" for="customCheck6">Emergency Lift</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="gas" value="gas" class="custom-control-input" id="customCheck7">
                    <label class="custom-control-label" for="customCheck7">Gas</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="water" value="water" class="custom-control-input" id="customCheck8">
                    <label class="custom-control-label" for="customCheck8">Water</label>
                  </div>
                </div>
              </div>
            </div>
