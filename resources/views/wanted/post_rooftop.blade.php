 	...
 	<div class="container">
 		<div class="pd-ltr-20 xs-pd-20-10">
 						...
 						<div class="col-md-6 col-sm-12">
 							...
 							<nav aria-label="breadcrumb" role="navigation">
 								<ol class="breadcrumb">
 									...
 									<li class="breadcrumb-item active" aria-current="page">Add Rooftop</li>
 								</ol>
 							</nav>
 						</div>
 				...
 				<div class="pd-20 card-box mb-30">
 					<div class="clearfix">
 						<div class="pull-left">
 							...
 							<p class="mb-30">Adding Rooftop Details</p>
 						</div>
 					...
 					@if ($message = Session::get('success'))
 												...
 												@endif
 					<form method="POST" action="{{ route('post_rooftop_information') }}" enctype="multipart/form-data">
 						@csrf
            <div class="col-md-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12 col-md-10">
                <input class="form-control" name="floor_area" placeholder="Type in sqft" type="number">
              </div>
            </div>
            <div class="form-group row">
                 ...
                 <div class="col-md-6 col-sm-12">
                   <div class="custom-control custom-checkbox mb-5">
                     ...
                     <label class="custom-control-label" for="customCheck1">Parking</label>
 									...
 									<div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="p_protection" value="p_protection" class="custom-control-input" id="customCheck2">
                     <label class="custom-control-label" for="customCheck2">Periphery Protection</label>
                   </div>
 									<div class="custom-control custom-checkbox mb-5">
                   ...
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="water" value="water" class="custom-control-input" id="customCheck7">
                     <label class="custom-control-label" for="customCheck7">Water</label>
                   </div>
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="shed" value="Shed" class="custom-control-input" id="customCheck8">
                     <label class="custom-control-label" for="customCheck8">Shed</label>
                   </div>
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="electricity" value="electricity" class="custom-control-input" id="customCheck9">
                     <label class="custom-control-label" for="customCheck9">Electricity</label>
                   </div>
