													...
													<div class="form-group">
														...
														<div class="row">
															<div class="col-md-6 col-sm-12">
																...
																<div class="custom-control custom-checkbox mb-5">
																	<input type="checkbox" name="electricity" value="Electricity" class="custom-control-input" id="customCheck31">
																	<label class="custom-control-label" for="customCheck31">Electricity</label>
																</div>
																<div class="custom-control custom-checkbox mb-5">
																	<input type="checkbox" name="water" value="Water" class="custom-control-input" id="customCheck32">
																	<label class="custom-control-label" for="customCheck32">Water</label>
																</div>
																<div class="custom-control custom-checkbox mb-5">
															...
															<div class="col-md-6 col-sm-12">
																...
																<div class="custom-control custom-checkbox mb-5">
																	<input type="checkbox" name="common_varanda" value="Common Varanda" class="custom-control-input" id="customCheck11*">
																	<label class="custom-control-label" for="customCheck11*">Common Varanda</label>
																</div>
																<div class="custom-control custom-checkbox mb-5">
																	<input type="checkbox" name="common_toilet" value="Common Toilet" class="custom-control-input" id="customCheck12*">
																	<label class="custom-control-label" for="customCheck12*">Common Toilet</label>
																</div>
															</div>
														</div>
													</div>
