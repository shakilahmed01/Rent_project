			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					@if ($message = Session::get('success'))
												...
												@endif
					<form method="POST" action="{{ route('post_ghat_information') }}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-6">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Ghat Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="ghat_name" placeholder="Name" value="">
							</div>
						</div>
						<div class="form-group row">
