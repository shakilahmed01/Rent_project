		...
		<div class="pd-ltr-20 xs-pd-20-10">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							...
							<p class="mb-30">Adding Land Details</p>
						</div>
					...
					@if ($message = Session::get('success'))
												...
												@endif
					<form method="POST" action="{{ route('post_land_information') }}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-6">
            ...
            <div class="form-group row">
              <label class="col-sm-12 col-md-2 col-form-label">Land Area</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="land_area" placeholder="Area land" type="number">
							</div>
            </div>
                ...
                <div class="col-md-6 col-sm-12">
                  <div class="custom-control custom-checkbox mb-5">
                    ...
                    <label class="custom-control-label" for="customCheck1">Electricity</label>
									...
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="gas" value="gas" class="custom-control-input" id="customCheck2">
                    <label class="custom-control-label" for="customCheck2">Gas</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="water" value="water" class="custom-control-input" id="customCheck3">
                    <label class="custom-control-label" for="customCheck3">Water</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="drainage_system" value="drainage_system" class="custom-control-input" id="customCheck4">
                    <label class="custom-control-label" for="customCheck4">Drainage system</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
