 ...
 <body>
 	...
 	<div class="container">
 		<div class="pd-ltr-20 xs-pd-20-10">
 				...
 				<div class="pd-20 card-box mb-30">
 					<div class="clearfix">
 						<div class="pull-left">
 							...
 							<p class="mb-30">Adding Factory Details</p>
 						</div>
 					...
 					@if ($message = Session::get('success'))
 												...
 												@endif
 					<form method="POST" action="{{ route('post_factory_information') }}" enctype="multipart/form-data">
 						@csrf
            <div class="col-md-6">
            ...
            <div class="form-group row">
 							<label class="col-sm-12 col-md-2 col-form-label">Factory Name</label>
 							<div class="col-sm-12 col-md-10">
 								<input class="form-control" name="factory_name" placeholder="Factory Name" type="text">
 							</div>
 						</div>
             ...
             <div class="form-group">
               ...
               <div class="row">
                 <div class="col-md-6 col-sm-12">
                   ...
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="gas" value="gas" class="custom-control-input" id="customCheck9">
                     <label class="custom-control-label" for="customCheck9">Gas</label>
                   </div>
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="water" value="water" class="custom-control-input" id="customCheck10">
                     <label class="custom-control-label" for="customCheck10">Water</label>
                   </div>
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="electricity" value="electricity" class="custom-control-input" id="customCheck11">
                     <label class="custom-control-label" for="customCheck11">Electricity</label>
                   </div>
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="ac" value="ac" class="custom-control-input" id="customCheck12">
                     <label class="custom-control-label" for="customCheck12">Ac</label>
                   </div>
