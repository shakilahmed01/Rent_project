 		...
 		<div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
               ...
               <div class="col-sm-12 col-md-10">
                 <input class="form-control" name="size" placeholder="Type in sqft" type="number">
               </div>
             </div>
             <div class="form-group row">
              ...
              <div class="weight-600 mb-3">Amneties</div>
               <div class="row">
                 <div class="col-md-6 col-sm-12">
                   ...
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="shed" value="shed" class="custom-control-input" id="customCheck4">
                     <label class="custom-control-label" for="customCheck4">Shed</label>
                   </div>
