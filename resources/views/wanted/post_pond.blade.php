 		...
 		<div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
               ...
               <div class="col-sm-12 col-md-10">
                 <input class="form-control" name="water_level" placeholder="Type in Liter" type="number">
               </div>
             </div>
             ...
             <div class="form-group row">
               ...
               <div class="col-sm-12 col-md-10">
                 <input class="form-control" name="pond_area" placeholder="Type in sqrft" type="number">
               </div>
             </div>
