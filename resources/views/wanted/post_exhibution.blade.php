				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Exhibution Center</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="{{route('index')}}">Home</a></li>
									<li class="breadcrumb-item active" aria-current="page">Add Exhibution Center</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							...
							<p class="mb-30">Adding Exibution Center Details</p>
						</div>
					...
					@if ($message = Session::get('success'))
												...
												@endif
					<form method="POST" action="{{ route('post_exibution_center_information') }}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-6">
              ...
              <div class="col-sm-12 col-md-10">
                <input class="form-control" name="price" placeholder="Price" type="numeric">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" name="exibution_center_name" placeholder="Exibution Center Name" type="text">
							</div>
						</div>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12">
                  <div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="toilet" value="toilet" class="custom-control-input" id="customCheck1">
                    <label class="custom-control-label" for="customCheck1">Toilet</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="lift" value="lift" class="custom-control-input" id="customCheck2">
                    <label class="custom-control-label" for="customCheck2">Lift</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="fire_exit" value="fire exit" class="custom-control-input" id="customCheck3">
                    <label class="custom-control-label" for="customCheck3">Fire Exit</label>
                  </div>
