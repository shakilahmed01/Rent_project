...
<body>
	...
	<div class="container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					@if ($message = Session::get('success'))
												...
												@endif
					<form method="POST" action="{{ route('post_building_information') }}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="building_name" placeholder="Name" value="">
							</div>
						</div>
						<div class="form-group row">
            ...
            <div class="form-group row">
              <label class="col-sm-12 col-md-2 col-form-label">Building Size</label>
              <div class="col-sm-12 col-md-10">
								<input class="form-control" name="building_size" placeholder="Type in sqft" type="number">
							</div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group">
                  <div class="weight-600 mb-3">Availibility</div>
              <div class="row">
                <div class="col-md-6 col-sm-12">
                  <div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="gas" value="Gas" class="custom-control-input" id="customCheck1">
                    <label class="custom-control-label" for="customCheck1">Gas</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="water" value="Water" class="custom-control-input" id="customCheck2">
                    <label class="custom-control-label" for="customCheck2">Water</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="electricity" value="Electricity" class="custom-control-input" id="customCheck3">
                    <label class="custom-control-label" for="customCheck3">Electricity</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    ...
                    <label class="custom-control-label" for="customCheck4">Lift</label>
									...
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="parking" value="Parking" class="custom-control-input" id="customCheck5">
