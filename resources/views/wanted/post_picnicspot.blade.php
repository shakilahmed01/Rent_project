...
<body>
	...
	<div class="container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					@if ($message = Session::get('success'))
												...
												@endif
					<form method="POST" action="{{ route('post_picnic_information') }}" enctype="multipart/form-data">
						@csrf
						<div class="col-md-6">
            ...
            <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Picnic Spot Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" name="picnic_spot_name" placeholder="Name" value="">
							</div>
						</div>
						<div class="form-group row">
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
                <textarea rows="4" cols="50" name="description" class="form-control" placeholder="Enter text here..."></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="row">
								<div class="col-md-6 col-sm-12">
									...
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" name="lift" value="lift" class="custom-control-input" id="customCheck15">
										<label class="custom-control-label" for="customCheck15">Lift</label>
									</div>

								</div>
								<div class="col-md-6 col-sm-12">
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" name="change_room" value="Change Room" class="custom-control-input" id="customCheck9">
										<label class="custom-control-label" for="customCheck9">Changing Room</label>
									</div>
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" name="shed" value="shed" class="custom-control-input" id="customCheck10">
										<label class="custom-control-label" for="customCheck10">Shed</label>
									</div>
									<div class="custom-control custom-checkbox mb-5">
									...
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" name="dining" value="dining" class="custom-control-input" id="customCheck13">
										<label class="custom-control-label" for="customCheck13">Dining Facilities</label>
									</div>
									<div class="custom-control custom-checkbox mb-5">
										<input type="checkbox" name="water" value="water" class="custom-control-input" id="customCheck14">
										<label class="custom-control-label" for="customCheck14">Water</label>
									</div>
								</div>
							</div>
						</div>
