                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <div class="custom-control custom-checkbox mb-5">
                    ...
                    <label class="custom-control-label" for="customCheck4">Lift/Elevator</label>
									...
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="dining" value="Dining facilities" class="custom-control-input" id="customCheck11">
                    <label class="custom-control-label" for="customCheck11">Dining facilities</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="sports" value="Sports facilities" class="custom-control-input" id="customCheck12">
                    <label class="custom-control-label" for="customCheck12">Sports facilities</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <div class="custom-control custom-checkbox mb-5">
                    ...
                    <label class="custom-control-label" for="customCheck8">Wifi</label>
									...
									<div class="custom-control custom-checkbox mb-5">
                    <input type="checkbox" name="ac" value="Ac" class="custom-control-input" id="customCheck9">
                    <label class="custom-control-label" for="customCheck9">Ac</label>
                  </div>
									<div class="custom-control custom-checkbox mb-5">
